...
Under observation af Kommunikationsdiagrammet, kan det ses, at det meste af arbejdet udføres af StoragePlanController, derfor den mest komplekse. Herunder kan de observares at Sales er med i Kommunikationsdiagrammet. Grundet for dette, er at Sale har indflydelse på, hvor meget der bestilles hjem til lagers, hvor meget der er på lageret og hvilket periode der bliver solgt flere af en bestemt is. 
