...
For at få en bedre forståelse af Niels Thomas, vil der blive lavet en Persona over ham.

\todo{this table gives fatal errors for some reason...}
%\begin{longtable}{ |p{120pt}|p{120pt}|p{120pt}| }\label{fig:persona}
%    \hline
%    TEXT GOES HERE & & \\
%    \hline
%\end{longtable}
