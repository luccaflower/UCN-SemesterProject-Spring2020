...
Som det første kan det hurtig etableres, at brugeren af systemet primært bliver depot chef Niels Thomas, da opgaverne primært er hans. Gruppen det vedrøre, er en gruppe primært fra fyrre op og op efter, som ikke meget interneterfaring har. Gruppen kan dog finde ud af at bruge de forskellige internet sider, og systemer. 

Burgergruppen, Niels Thomas er en del af, har i forvejen kendskab til opgaverne der skal udføres, samt det nuværende system opgaverne skal udføres i. For at få en bedre forståelse af Niels Thomas, vil der blive lavet en Persona over ham.

Knapperne og teksten er designet til at være store letlæselige bogstaver, og der er høj kontrast mellem baggrunden og interaktive dele. Der er lagt fokus på at gøre trinene og knap-placeringerne så intuitive som mulige, så det ikke er svært at lære, hvilket kan være en udfordring for den aldersgruppe Niels Thomas er en del af.
Det forventes at farverne og skrifttypen, som stemmer overens med Hjem-IS' hjemmeside \cite{hjemis}. Eftersom Niels Thomas under interviewet har udtrykt et ønske om at kunne spare tid på sine opgaver i systemet, så han kan bruge mere tid på at køre salgsruter, er det vigtigt at det ikke er svært at lære det nye system at kende. Derfor vil Niels Thomas også have en forventning til at det nye system skal kunne være nemt at bruge så det lykkedes at opfylde ønsket om at kunne spare tid på sine opgaver. 
...
\subsection{Feedback}
\todo{Perform mockup test with customer and write results/feedback}
