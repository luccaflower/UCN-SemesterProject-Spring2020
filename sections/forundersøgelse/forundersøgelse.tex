...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Forundersøgelse/workflows.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Forundersøgelse/use_case_diagram.eps}
...
\textbf{Modtag varer:} \\
En lagermedarbejder modtager varerne, når en lastbilerne fylder fryseren ud. Herfra registeres de modtagede varer. 
