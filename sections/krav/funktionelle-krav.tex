...
Efter en vurdering af begge centrale Use Cases, vælges Automatisk Lagerstyring som 

\section{Kandidattabel}
Nu hvor de centrale Use Cases er valgt, kan der nu laves Kandidatklasser. Der vil laves en vurdering af hvilke mulige klasser, som passer til de "objekter", der indgår i arbejdsopgaverne. 
...
\begin{longtable}{|p{120pt}|p{120pt}|p{120pt}|}\label{fig:Kandidatklasser}
    ...
    \hline
    DepotPlan & Beskriver hvordan debottet skal ændre sig som seasonerne gør & klasse \\
    \hline
\end{longtable}
