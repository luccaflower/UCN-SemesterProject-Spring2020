...
\begin{longtable}{|p{120pt}|p{120pt}|p{120pt}|}\label{fig:Kandidatklasser}
    ...
    \hline
    \hline
    Fryser & Skal kunne indeholde lageroplysninger &  \\
    \hline
    Lagerplan & Skal kunne indeholde bestillingsantal af flere is & \\
    \hline
    Is & Skal kunne registrere produktoplysninger og lagerstatus & \\
    \hline
    Bruger & Skal kunne tilgå systemet og registrere en bestilling & \\
    \hline
    SalgsDatabase & Skal kunne registrere salg i database & IN \\
    \hline
    Bestilling & Skal kunne indeholde liste med is og antal & IN \\
    \hline
    Salg & Indeholder produkt, antal og kroner betalt & IN \\
    \hline
\end{longtable}
