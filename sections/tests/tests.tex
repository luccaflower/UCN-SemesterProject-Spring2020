...
Vores tests bliver primært unit-tests, der er implementeret efter "Arrange, Act, Assert"-mønstret, hvor tests bliver eksekveret i tre skridt\cite{ArrangeActAssert}:
\begin{description}
