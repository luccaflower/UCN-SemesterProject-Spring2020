...
I dette afsnit bliver der fokuseret på Business modeling fasen under Unified Process\cite{UnifiedProcess}. Dette indebære en forståelse for målenede for organisationen, som vil hjælpe gruppen finde brugbare informationer omkring hvad der skal inkluderes i systemet\cite{UP}. Ved at analyse organisationen og dens process kan gruppen herfra udvilke et system, som kan blive en organisk del af Hjem-Is.
