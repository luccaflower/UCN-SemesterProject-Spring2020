...
I dette afsnit bliver der fokuseret på Business Modelling aktiviteten under Unified Process\cite{UnifiedProcess}. Denne aktivitet fylder meget i Inception fasen, som skal danne et overblik over kravene, og ender her ud i en Business Case\cite{ProjectManagement}. Ud fra analysen og Business Casen kan der dannes et overblik over, hvad projektet skal omhandle, samt om det skal gennemføres. %Der vil introduceres en undersøgelse af hvilke Use Cases, der skal integreres i systemet. 
